...
export const ColorForm: React.FC<ColorFormProps> = ({ initialData }) => {
  ...
  const description = initialData
    ? "Editar un Color"
    : "Añade una nuevo color de producto";
  const toastMessage = initialData ? "Color actualizado" : "C creada";
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error("Primero elimine todas los productos usados en este color");
    } finally {
      setLoading(false);
      setOpen(false);
    }
