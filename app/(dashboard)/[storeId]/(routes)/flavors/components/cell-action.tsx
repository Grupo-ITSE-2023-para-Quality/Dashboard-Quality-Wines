...
export const CellAction: React.FC<CellActionsProps> = ({ data }) => {
  ...
  const onCopy = (id: string) => {
    ...
    toast.success("Id de variedad copiado en el portapapeles");
  };
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error(
        "Elimine primero todos los productos usados con esta variedad"
      );
    } finally {
      setLoading(false);
      setOpen(false);
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/${params.storeId}/flavors/${data.id}`)
            }
          >
